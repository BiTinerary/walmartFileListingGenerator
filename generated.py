...
class mainApp(tk.Tk): # The core class for creating tkinter GUI
	def __init__(self):
		...
		def getInput():
			inputArray = [entry1.get(), re.sub('[^A-Za-z0-9<>/]+', '', entry2.get(1.0, END)), entry3.get(), entry4.get(), entry5.get(), entry6.get(), entry7.get(), entry8.get(), entry9.get(), entry10.get(), entry11.get(), entry12.get(), entry13.get(), entry14.get(), entry15.get(), entry16.get(), entry17.get(), entry18.get(), entry19.get()]
		...
		entry1 = tk.Entry(self, width=80)
		entry1.grid(row=1, column=1, padx=5, pady=1)

		label2 = tk.Label(width=25, height=5, anchor='w', relief='ridge', text="Long Description")
		label2.grid(row=2, column=0, padx=5, pady=1)
		entry2 = ScrolledText(self, width=58, height=5)
		...
		entry10 = tk.Entry(self, width=80)
		...
		entry11 = tk.Entry(self, width=80)
		...
		entry12 = tk.Entry(self, width=80)
		...
		entry13 = tk.Entry(self, width=80)
		...
		entry14 = tk.Entry(self, width=80)
		...
		entry15 = tk.Entry(self, width=80)
		...
		entry16 = tk.Entry(self, width=80)
		...
		entry17 = tk.Entry(self, width=80)
		...
		entry18 = tk.Entry(self, width=80)
		...
		entry19 = tk.Entry(self, width=80)
